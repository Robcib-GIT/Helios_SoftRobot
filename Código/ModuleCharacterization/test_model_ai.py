...
axs[0].plot(theta_expected_deg)
axs[0].plot(theta_predicted_deg)
...
axs[1].plot(phi_expected_deg)
axs[1].plot(phi_predicted_deg)
...
axs[2].plot(length_expected)
axs[2].plot(length_predicted)
